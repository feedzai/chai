      ...
      Object.defineProperty(ctx, name,
        { get: function () {
            ...
            Object.getOwnPropertyNames(result).forEach(function (key) {
                var functionProtoPD = Object.getOwnPropertyDescriptor(Function.prototype, key), prop_description;
    
                // Avoid trying to overwrite things that we can't, like `length` and `arguments`.
                if (functionProtoPD && !functionProtoPD.configurable) return;
                if (key === 'arguments') return; // @see chaijs/chai/issues/69
    
                prop_description = Object.getOwnPropertyDescriptor(result, key);
    
                if (prop_description === Object(prop_description)) {
                    Object.defineProperty(newResult, key, prop_description);
                }
            });
